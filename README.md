...
- C#/SMAPI is new for me; learning the modding API (querying NPC gift preferences, tracking player position, handling item quantities) will take some time, so it's best started early.
